...
AWS_CLOUDFORMATION_RESOURCES = {
    ...
    'healthlake': {},
    'iam': {'group': 'AWS::IAM::Group', 'instance-profile': 'AWS::IAM::InstanceProfile', 'oidc-provider': 'AWS::IAM::OIDCProvider', 'policy': 'AWS::IAM::Policy', 'role': 'AWS::IAM::Role', 'saml-provider': 'AWS::IAM::SAMLProvider', 'server-certificate': 'AWS::IAM::ServerCertificate', 'user': 'AWS::IAM::User'},
