...
AWS_CLOUDFORMATION_RESOURCES = {
    ...
    'ses': {'configuration-set': 'AWS::SES::ConfigurationSet', 'contact-list': 'AWS::SES::ContactList', 'dedicated-ip-pool': 'AWS::SES::DedicatedIpPool', 'identity': 'AWS::PinpointEmail::Identity', 'mailmanager-address-list': 'AWS::SES::MailManagerAddressList', 'mailmanager-archive': 'AWS::SES::MailManagerArchive', 'mailmanager-ingress-point': 'AWS::SES::MailManagerIngressPoint', 'mailmanager-rule-set': 'AWS::SES::MailManagerRuleSet', 'mailmanager-traffic-policy': 'AWS::SES::MailManagerTrafficPolicy', 'multi-region-endpoint': 'AWS::SES::MultiRegionEndpoint', 'template': 'AWS::SES::Template', 'tenant': 'AWS::SES::Tenant'},
