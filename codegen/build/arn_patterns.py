...
AWS_CLOUDFORMATION_RESOURCES = {
    ...
    'codeguru-reviewer': {},
    'codepipeline': {'pipeline': 'AWS::CodePipeline::Pipeline', 'webhook': 'AWS::CodePipeline::Webhook'},
