...
AWS_CLOUDFORMATION_RESOURCES = {
    ...
    'elasticloadbalancing': {'loadbalancer': 'AWS::ElasticLoadBalancing::LoadBalancer', 'targetgroup': 'AWS::ElasticLoadBalancingV2::TargetGroup', 'truststore': 'AWS::ElasticLoadBalancingV2::TrustStore'},
