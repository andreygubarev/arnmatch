...
AWS_CLOUDFORMATION_RESOURCES = {
    ...
    'iot': {'authorizer': 'AWS::IoT::Authorizer', 'billinggroup': 'AWS::IoT::BillingGroup', 'certificateprovider': 'AWS::IoT::CertificateProvider', 'command': 'AWS::IoT::Command', 'custommetric': 'AWS::IoT::CustomMetric', 'dimension': 'AWS::IoT::Dimension', 'domainconfiguration': 'AWS::IoT::DomainConfiguration', 'fleetmetric': 'AWS::IoT::FleetMetric', 'jobtemplate': 'AWS::IoT::JobTemplate', 'mitigationaction': 'AWS::IoT::MitigationAction', 'policy': 'AWS::IoT::Policy', 'provisioningtemplate': 'AWS::IoT::ProvisioningTemplate', 'rolealias': 'AWS::IoT::RoleAlias', 'scheduledaudit': 'AWS::IoT::ScheduledAudit', 'securityprofile': 'AWS::IoT::SecurityProfile', 'thing': 'AWS::IoT::Thing', 'thingtype': 'AWS::IoT::ThingType'},
