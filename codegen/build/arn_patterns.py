...
ARN_PATTERNS = {
    ...
    'access-analyzer': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):access-analyzer:(?P<Region>[\w-]*):(?P<Account>\d{12}):analyzer/(?P<AnalyzerName>.+?)/archive-rule/(?P<RuleName>.+?)$"), ['archive-rule']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):access-analyzer:(?P<Region>[\w-]*):(?P<Account>\d{12}):analyzer/(?P<AnalyzerName>.+?)$"), ['analyzer']),
    ],
    'account': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):account::(?P<ManagementAccountId>.+?):account/o-(?P<OrganizationId>.+?)/(?P<MemberAccountId>.+?)$"), ['account-in-organization']),
    ...
    'aidevops': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):aidevops:(?P<Region>[\w-]*):(?P<Account>\d{12}):agentspace/(?P<AgentSpaceId>.+?)/associations/(?P<AssociationId>.+?)$"), ['association-resource']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):aidevops:(?P<Region>[\w-]*):(?P<Account>\d{12}):agentspace/(?P<AgentSpaceId>.+?)$"), ['agent-space-resource']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):aidevops:(?P<Region>[\w-]*):(?P<Account>\d{12}):service/(?P<ServiceId>.+?)$"), ['service-resource']),
    ],
    'aiops': [
    ...
    'amplifyuibuilder': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):amplifyuibuilder:(?P<Region>[\w-]*):(?P<Account>\d{12}):app/(?P<AppId>.+?)/environment/(?P<EnvironmentName>.+?)/codegen-jobs/(?P<Id>.+?)$"), ['codegen-job-resource']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):amplifyuibuilder:(?P<Region>[\w-]*):(?P<Account>\d{12}):app/(?P<AppId>.+?)/environment/(?P<EnvironmentName>.+?)/components/(?P<Id>.+?)$"), ['component-resource']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):amplifyuibuilder:(?P<Region>[\w-]*):(?P<Account>\d{12}):app/(?P<AppId>.+?)/environment/(?P<EnvironmentName>.+?)/forms/(?P<Id>.+?)$"), ['form-resource']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):amplifyuibuilder:(?P<Region>[\w-]*):(?P<Account>\d{12}):app/(?P<AppId>.+?)/environment/(?P<EnvironmentName>.+?)/themes/(?P<Id>.+?)$"), ['theme-resource']),
    ],
    'aoss': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):aoss:(?P<Region>[\w-]*):(?P<Account>\d{12}):collection/(?P<CollectionId>.+?)$"), ['collection']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):aoss:(?P<Region>[\w-]*):(?P<Account>\d{12}):collection-group/(?P<CollectionGroupId>.+?)$"), ['collection-group']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):aoss:(?P<Region>[\w-]*):(?P<Account>\d{12}):dashboards/default$"), ['dashboards']),
    ],
    'apigateway': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/restapis/(?P<RestApiId>.+?)/resources/(?P<ResourceId>.+?)/methods/(?P<HttpMethodType>.+?)/integration/responses/(?P<StatusCode>.+?)$"), ['integration-response']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/restapis/(?P<RestApiId>.+?)/resources/(?P<ResourceId>.+?)/methods/(?P<HttpMethodType>.+?)/responses/(?P<StatusCode>.+?)$"), ['method-response']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/apis/(?P<ApiId>.+?)/integrations/(?P<IntegrationId>.+?)/integrationresponses/(?P<IntegrationResponseId>.+?)$"), ['integration-response']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/apis/(?P<ApiId>.+?)/routes/(?P<RouteId>.+?)/requestparameters/(?P<RequestParameterKey>.+?)$"), ['route-request-parameter']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/apis/(?P<ApiId>.+?)/routes/(?P<RouteId>.+?)/routeresponses/(?P<RouteResponseId>.+?)$"), ['route-response']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/apis/(?P<ApiId>.+?)/stages/(?P<StageName>.+?)/cache/authorizers$"), ['authorizers-cache']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/apis/(?P<ApiId>.+?)/stages/(?P<StageName>.+?)/routesettings/(?P<RouteKey>.+?)$"), ['route-settings']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/domainnames/(?P<DomainName>.+?)\+(?P<DomainIdentifier>.+?)/basepathmappings/(?P<BasePath>.+?)$"), ['private-base-path-mapping']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/apis/(?P<ApiId>.+?)/integrations/(?P<IntegrationId>.+?)/integrationresponses$"), ['integration-responses']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/apis/(?P<ApiId>.+?)/models/(?P<ModelId>.+?)/template$"), ['model-template']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/apis/(?P<ApiId>.+?)/routes/(?P<RouteId>.+?)/routeresponses$"), ['route-responses']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/apis/(?P<ApiId>.+?)/stages/(?P<StageName>.+?)/accesslogsettings$"), ['access-log-settings']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/domainnames/(?P<DomainName>.+?)\+(?P<DomainIdentifier>.+?)/basepathmappings$"), ['private-base-path-mappings']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/restapis/(?P<RestApiId>.+?)/documentation/parts/(?P<DocumentationPartId>.+?)$"), ['documentation-part']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/restapis/(?P<RestApiId>.+?)/documentation/versions/(?P<DocumentationVersionId>.+?)$"), ['documentation-version']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/apis/(?P<ApiId>.+?)/exports/(?P<Specification>.+?)$"), ['exported-a-p-i']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/domainnames/(?P<DomainName>.+?)/apimappings/(?P<ApiMappingId>.+?)$"), ['api-mapping']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/domainnames/(?P<DomainName>.+?)/basepathmappings/(?P<BasePath>.+?)$"), ['base-path-mapping']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/restapis/(?P<RestApiId>.+?)/documentation/parts$"), ['documentation-parts']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/restapis/(?P<RestApiId>.+?)/documentation/versions$"), ['documentation-versions']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/restapis/(?P<RestApiId>.+?)/gatewayresponses/(?P<ResponseType>.+?)$"), ['gateway-response']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/restapis/(?P<RestApiId>.+?)/models/(?P<ModelName>.+?)$"), ['model']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/restapis/(?P<RestApiId>.+?)/requestvalidators/(?P<RequestValidatorId>.+?)$"), ['request-validator']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/usageplans/(?P<UsagePlanId>.+?)/keys/(?P<Id>.+?)$"), ['usage-plan-key']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/domainnames/(?P<DomainName>.+?)/apimappings$"), ['api-mappings']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/domainnames/(?P<DomainName>.+?)/basepathmappings$"), ['base-path-mappings']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/restapis/(?P<RestApiId>.+?)/gatewayresponses$"), ['gateway-responses']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/restapis/(?P<RestApiId>.+?)/models$"), ['models']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/restapis/(?P<RestApiId>.+?)/requestvalidators$"), ['request-validators']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/usageplans/(?P<UsagePlanId>.+?)/keys$"), ['usage-plan-keys']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/apikeys/(?P<ApiKeyId>.+?)$"), ['api-key']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/apis/(?P<ApiId>.+?)$"), ['api']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/clientcertificates/(?P<ClientCertificateId>.+?)$"), ['client-certificate']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/domainnames/(?P<DomainName>.+?)$"), ['domain-name']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/restapis/(?P<RestApiId>.+?)$"), ['rest-api']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/tags/(?P<UrlEncodedResourceARN>.+?)$"), ['tags']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/usageplans/(?P<UsagePlanId>.+?)$"), ['usage-plan']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/vpclinks/(?P<VpcLinkId>.+?)$"), ['vpc-link']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/account$"), ['account']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/apikeys$"), ['api-keys']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/apis$"), ['apis']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/clientcertificates$"), ['client-certificates']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/domainnames$"), ['domain-names']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/restapis$"), ['rest-apis']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/usageplans$"), ['usage-plans']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*)::/vpclinks$"), ['vpc-links']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*):(?P<Account>\d{12}):/domainnameaccessassociations/domainname/(?P<DomainName>.+?)/(?P<SourceType>.+?)/(?P<SourceId>.+?)$"), ['domain-name-access-association']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*):(?P<Account>\d{12}):/domainnames/(?P<DomainName>.+?)\+(?P<DomainIdentifier>.+?)$"), ['private-domain-name']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*):(?P<Account>\d{12}):/domainnames/(?P<DomainName>.+?)/routingrules/(?P<RoutingRuleId>.+?)$"), ['routing-rule']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*):(?P<Account>\d{12}):/portalproducts/(?P<PortalProductId>.+?)/productpages/(?P<ProductPageId>.+?)$"), ['product-page']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*):(?P<Account>\d{12}):/portalproducts/(?P<PortalProductId>.+?)/productrestendpointpages/(?P<ProductRestEndpointPageId>.+?)$"), ['product-rest-endpoint-page']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*):(?P<Account>\d{12}):/portalproducts/(?P<PortalProductId>.+?)$"), ['portal-product']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*):(?P<Account>\d{12}):/portals/(?P<PortalId>.+?)$"), ['portal']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apigateway:(?P<Region>[\w-]*):(?P<Account>\d{12}):/domainnameaccessassociations$"), ['domain-name-access-associations']),
    ],
    'app-integrations': [
    ...
    'application-autoscaling': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):application-autoscaling:(?P<Region>[\w-]*):(?P<Account>\d{12}):scalable-target/(?P<ResourceId>.+?)$"), ['scalable-target']),
    ],
    'application-signals': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):application-signals:(?P<Region>[\w-]*):(?P<Account>\d{12}):slo/(?P<SloName>.+?)$"), ['slo']),
    ],
    'appmesh': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):appmesh:(?P<Region>[\w-]*):(?P<Account>\d{12}):mesh/(?P<MeshName>.+?)/virtualGateway/(?P<VirtualGatewayName>.+?)/gatewayRoute/(?P<GatewayRouteName>.+?)$"), ['gateway-route']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):appmesh:(?P<Region>[\w-]*):(?P<Account>\d{12}):mesh/(?P<MeshName>.+?)/virtualGateway/(?P<VirtualGatewayName>.+?)$"), ['virtual-gateway']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):appmesh:(?P<Region>[\w-]*):(?P<Account>\d{12}):mesh/(?P<MeshName>.+?)/virtualNode/(?P<VirtualNodeName>.+?)$"), ['virtual-node']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):appmesh:(?P<Region>[\w-]*):(?P<Account>\d{12}):mesh/(?P<MeshName>.+?)/virtualRouter/(?P<VirtualRouterName>.+?)$"), ['virtual-router']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):appmesh:(?P<Region>[\w-]*):(?P<Account>\d{12}):mesh/(?P<MeshName>.+?)/virtualService/(?P<VirtualServiceName>.+?)$"), ['virtual-service']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):appmesh:(?P<Region>[\w-]*):(?P<Account>\d{12}):mesh/(?P<MeshName>.+?)$"), ['mesh']),
    ],
    'appmesh-preview': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):appmesh-preview:(?P<Region>[\w-]*):(?P<Account>\d{12}):mesh/(?P<MeshName>.+?)/virtualGateway/(?P<VirtualGatewayName>.+?)/gatewayRoute/(?P<GatewayRouteName>.+?)$"), ['gateway-route']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):appmesh-preview:(?P<Region>[\w-]*):(?P<Account>\d{12}):mesh/(?P<MeshName>.+?)/virtualGateway/(?P<VirtualGatewayName>.+?)$"), ['virtual-gateway']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):appmesh-preview:(?P<Region>[\w-]*):(?P<Account>\d{12}):mesh/(?P<MeshName>.+?)/virtualNode/(?P<VirtualNodeName>.+?)$"), ['virtual-node']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):appmesh-preview:(?P<Region>[\w-]*):(?P<Account>\d{12}):mesh/(?P<MeshName>.+?)/virtualRouter/(?P<VirtualRouterName>.+?)$"), ['virtual-router']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):appmesh-preview:(?P<Region>[\w-]*):(?P<Account>\d{12}):mesh/(?P<MeshName>.+?)/virtualService/(?P<VirtualServiceName>.+?)$"), ['virtual-service']),
    ...
    'appsync': [
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):appsync:(?P<Region>[\w-]*):(?P<Account>\d{12}):apis/(?P<ApiId>.+?)/channelNamespace/(?P<ChannelNamespaceName>.+?)$"), ['channel-namespace']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):appsync:(?P<Region>[\w-]*):(?P<Account>\d{12}):apis/(?P<SourceGraphQLAPIId>.+?)/mergedApiAssociations/(?P<Associationid>.+?)$"), ['merged-api-association']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):appsync:(?P<Region>[\w-]*):(?P<Account>\d{12}):apis/(?P<MergedGraphQLAPIId>.+?)/sourceApiAssociations/(?P<Associationid>.+?)$"), ['source-api-association']),
    ...
    'apptest': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apptest:(?P<Region>[\w-]*):(?P<Account>\d{12}):testcase/(?P<TestCaseId>.+?)$"), ['test-case']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apptest:(?P<Region>[\w-]*):(?P<Account>\d{12}):testconfiguration/(?P<TestConfigurationId>.+?)$"), ['test-configuration']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apptest:(?P<Region>[\w-]*):(?P<Account>\d{12}):testrun/(?P<TestRunId>.+?)$"), ['test-run']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):apptest:(?P<Region>[\w-]*):(?P<Account>\d{12}):testsuite/(?P<TestSuiteId>.+?)$"), ['test-suite']),
    ],
    'aps': [
    ...
    'auditmanager': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):auditmanager:(?P<Region>[\w-]*):(?P<Account>\d{12}):assessment/(?P<AssessmentId>.+?)/controlSet/(?P<ControlSetId>.+?)$"), ['assessment-control-set']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):auditmanager:(?P<Region>[\w-]*):(?P<Account>\d{12}):assessment/(?P<AssessmentId>.+?)$"), ['assessment']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):auditmanager:(?P<Region>[\w-]*):(?P<Account>\d{12}):assessmentFramework/(?P<AssessmentFrameworkId>.+?)$"), ['assessment-framework']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):auditmanager:(?P<Region>[\w-]*):(?P<Account>\d{12}):control/(?P<ControlId>.+?)$"), ['control']),
    ],
    'autoscaling': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):autoscaling:(?P<Region>[\w-]*):(?P<Account>\d{12}):autoScalingGroup:(?P<GroupId>.+?):autoScalingGroupName/(?P<GroupFriendlyName>.+?)$"), ['auto-scaling-group']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):autoscaling:(?P<Region>[\w-]*):(?P<Account>\d{12}):launchConfiguration:(?P<Id>.+?):launchConfigurationName/(?P<LaunchConfigurationName>.+?)$"), ['launch-configuration']),
    ],
    'aws-marketplace': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):aws-marketplace:(?P<Region>[\w-]*):(?P<Account>\d{12}):DeploymentParameter:catalogs/(?P<CatalogName>.+?)/products/(?P<ProductId>.+?)/(?P<ResourceId>.+?)$"), ['deployment-parameter']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):aws-marketplace:(?P<Region>[\w-]*):(?P<Account>\d{12}):(?P<Catalog>.+?)/ChangeSet/(?P<ResourceId>.+?)$"), ['change-set']),
    ...
    'backup': [
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):backup:(?P<Region>[\w-]*):(?P<Account>\d{12}):report-plan:(?P<ReportPlanName>.+?)-(?P<ReportPlanId>.+?)$"), ['report-plan']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):backup:(?P<Region>[\w-]*):(?P<Account>\d{12}):restore-testing-plan:(?P<RestoreTestingPlanName>.+?)-(?P<RestoreTestingPlanId>.+?)$"), ['restore-testing-plan']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):backup:(?P<Region>[\w-]*):(?P<Account>\d{12}):tiering-configuration:(?P<TieringConfigurationName>.+?)-(?P<TieringConfigurationId>.+?)$"), ['tiering-configuration']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):backup:(?P<Region>[\w-]*):(?P<Account>\d{12}):backup-plan:(?P<BackupPlanId>.+?)$"), ['backup-plan', 'backup-plan']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):backup:(?P<Region>[\w-]*):(?P<Account>\d{12}):backup-vault:(?P<BackupVaultName>.+?)$"), ['backup-vault', 'backup-vault']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):backup:(?P<Region>[\w-]*):(?P<Account>\d{12}):legal-hold:(?P<LegalHoldId>.+?)$"), ['legal-hold']),
    ],
    'backup-gateway': [
    ...
    'backup-search': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):backup-search:(?P<Region>[\w-]*):(?P<Account>\d{12}):search-export-job/(?P<ResourceId>.+?)$"), ['search-export-job']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):backup-search:(?P<Region>[\w-]*):(?P<Account>\d{12}):search-job/(?P<ResourceId>.+?)$"), ['search-job']),
    ],
    'batch': [
    ...
    'budgets': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):budgets::(?P<Account>\d{12}):budget/(?P<BudgetName>.+?)/action/(?P<ActionId>.+?)$"), ['budget-action']),
    ...
    'cases': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):cases:(?P<Region>[\w-]*):(?P<Account>\d{12}):domain/(?P<DomainId>.+?)/case/(?P<CaseId>.+?)/related-item/(?P<RelatedItemId>.+?)$"), ['related-item']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):cases:(?P<Region>[\w-]*):(?P<Account>\d{12}):domain/(?P<DomainId>.+?)/case/(?P<CaseId>.+?)$"), ['case']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):cases:(?P<Region>[\w-]*):(?P<Account>\d{12}):domain/(?P<DomainId>.+?)/case-rule/(?P<CaseRuleId>.+?)$"), ['case-rule']),
    ...
    'chatbot': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):chatbot::(?P<Account>\d{12}):chat-configuration/(?P<ConfigurationType>.+?)/(?P<ChatbotConfigurationName>.+?)$"), ['chatbot-configuration']),
    ...
    'cleanrooms-ml': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):cleanrooms-ml:(?P<Region>[\w-]*):(?P<Account>\d{12}):membership/(?P<MembershipId>.+?)/configured-model-algorithm-association/(?P<ResourceId>.+?)$"), ['configured-model-algorithm-association']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):cleanrooms-ml:(?P<Region>[\w-]*):(?P<Account>\d{12}):membership/(?P<MembershipId>.+?)/ml-input-channel/(?P<ResourceId>.+?)$"), ['m-l-input-channel']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):cleanrooms-ml:(?P<Region>[\w-]*):(?P<Account>\d{12}):membership/(?P<MembershipId>.+?)/trained-model/(?P<ResourceId>.+?)$"), ['trained-model']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):cleanrooms-ml:(?P<Region>[\w-]*):(?P<Account>\d{12}):membership/(?P<MembershipId>.+?)/trained-model-inference-job/(?P<ResourceId>.+?)$"), ['trained-model-inference-job']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):cleanrooms-ml:(?P<Region>[\w-]*):(?P<Account>\d{12}):configured-model-algorithm/(?P<ResourceId>.+?)$"), ['configured-model-algorithm']),
    ...
    'clouddirectory': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):clouddirectory:(?P<Region>[\w-]*):(?P<Account>\d{12}):directory/(?P<DirectoryId>.+?)/schema/(?P<SchemaName>.+?)/(?P<Version>.+?)$"), ['applied-schema']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):clouddirectory:(?P<Region>[\w-]*):(?P<Account>\d{12}):schema/published/(?P<SchemaName>.+?)/(?P<Version>.+?)$"), ['published-schema']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):clouddirectory:(?P<Region>[\w-]*):(?P<Account>\d{12}):schema/development/(?P<SchemaName>.+?)$"), ['development-schema']),
    ...
    'cloudformation': [
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):cloudformation:(?P<Region>[\w-]*):(?P<Account>\d{12}):type/hook/(?P<Type>.+?)$"), ['type-hook']),
    ...
    'codeconnections': [
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):codeconnections:(?P<Region>[\w-]*):(?P<Account>\d{12}):repository-link/(?P<RepositoryLinkId>.+?)$"), ['repository-link']),
    ],
    'codedeploy': [
    ...
    'codeguru-profiler': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):codeguru-profiler:(?P<Region>[\w-]*):(?P<Account>\d{12}):profilingGroup/(?P<ProfilingGroupName>.+?)$"), ['profiling-group']),
    ],
    'codeguru-reviewer': [
    ...
    'codeguru-security': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):codeguru-security:(?P<Region>[\w-]*):(?P<Account>\d{12}):scans/(?P<ScanName>.+?)$"), ['scan-name']),
    ],
    'codepipeline': [
    ...
    'codestar-connections': [
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):codestar-connections:(?P<Region>[\w-]*):(?P<Account>\d{12}):repository-link/(?P<RepositoryLinkId>.+?)$"), ['repository-link']),
    ],
    ...
    'compute-optimizer': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):compute-optimizer::(?P<Account>\d{12}):automation-rule/(?P<RuleId>.+?)$"), ['automation-rule']),
    ],
    'config': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):config:(?P<Region>[\w-]*):(?P<Account>\d{12}):aggregation-authorization/(?P<AggregatorAccount>.+?)/(?P<AggregatorRegion>.+?)$"), ['aggregation-authorization']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):config:(?P<Region>[\w-]*):(?P<Account>\d{12}):configuration-recorder/(?P<RecorderName>.+?)/(?P<RecorderId>.+?)$"), ['configuration-recorder']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):config:(?P<Region>[\w-]*):(?P<Account>\d{12}):conformance-pack/(?P<ConformancePackName>.+?)/(?P<ConformancePackId>.+?)$"), ['conformance-pack']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):config:(?P<Region>[\w-]*):(?P<Account>\d{12}):stored-query/(?P<StoredQueryName>.+?)/(?P<StoredQueryId>.+?)$"), ['stored-query']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):config:(?P<Region>[\w-]*):(?P<Account>\d{12}):config-aggregator/(?P<AggregatorId>.+?)$"), ['configuration-aggregator']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):config:(?P<Region>[\w-]*):(?P<Account>\d{12}):config-rule/(?P<ConfigRuleId>.+?)$"), ['config-rule']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):config:(?P<Region>[\w-]*):(?P<Account>\d{12}):organization-config-rule/(?P<OrganizationConfigRuleId>.+?)$"), ['organization-config-rule']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):config:(?P<Region>[\w-]*):(?P<Account>\d{12}):organization-conformance-pack/(?P<OrganizationConformancePackId>.+?)$"), ['organization-conformance-pack']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):config:(?P<Region>[\w-]*):(?P<Account>\d{12}):remediation-configuration/(?P<RemediationConfigurationId>.+?)$"), ['remediation-configuration']),
    ],
    'connect': [
    ...
    'consoleapp': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):consoleapp::(?P<Account>\d{12}):device/(?P<DeviceId>.+?)/identity/(?P<IdentityId>.+?)$"), ['device-identity']),
    ],
    'controlcatalog': [
    ...
    'controltower': [
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):controltower:(?P<Region>[\w-]*):(?P<Account>\d{12}):enabledbaseline/(?P<EnabledBaselineId>.+?)$"), ['enabled-baseline']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):controltower:(?P<Region>[\w-]*):(?P<Account>\d{12}):enabledcontrol/(?P<EnabledControlId>.+?)$"), ['enabled-control']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):controltower:(?P<Region>[\w-]*):(?P<Account>\d{12}):landingzone/(?P<LandingZoneId>.+?)$"), ['landing-zone']),
    ],
    'cur': [
    ...
    'dms': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):dms:(?P<Region>[\w-]*):(?P<Account>\d{12}):assessment-run:(?P<AssessmentRunId>.+?)$"), ['replication-task-assessment-run']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):dms:(?P<Region>[\w-]*):(?P<Account>\d{12}):cert:(?P<CertificateId>.+?)$"), ['certificate']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):dms:(?P<Region>[\w-]*):(?P<Account>\d{12}):data-migration:(?P<DataMigrationId>.+?)$"), ['data-migration']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):dms:(?P<Region>[\w-]*):(?P<Account>\d{12}):data-provider:(?P<DataProviderId>.+?)$"), ['data-provider']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):dms:(?P<Region>[\w-]*):(?P<Account>\d{12}):endpoint:(?P<EndpointId>.+?)$"), ['endpoint']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):dms:(?P<Region>[\w-]*):(?P<Account>\d{12}):es:(?P<EventSubscriptionId>.+?)$"), ['event-subscription']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):dms:(?P<Region>[\w-]*):(?P<Account>\d{12}):individual-assessment:(?P<IndividualAssessmentId>.+?)$"), ['replication-task-individual-assessment']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):dms:(?P<Region>[\w-]*):(?P<Account>\d{12}):instance-profile:(?P<InstanceProfileId>.+?)$"), ['instance-profile']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):dms:(?P<Region>[\w-]*):(?P<Account>\d{12}):migration-project:(?P<MigrationProjectId>.+?)$"), ['migration-project']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):dms:(?P<Region>[\w-]*):(?P<Account>\d{12}):rep:(?P<ReplicationInstanceId>.+?)$"), ['replication-instance']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):dms:(?P<Region>[\w-]*):(?P<Account>\d{12}):replication-config:(?P<ReplicationConfigId>.+?)$"), ['replication-config']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):dms:(?P<Region>[\w-]*):(?P<Account>\d{12}):subgrp:(?P<SubnetGroupName>.+?)$"), ['replication-subnet-group', 'subgrp']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):dms:(?P<Region>[\w-]*):(?P<Account>\d{12}):task:(?P<TaskId>.+?)$"), ['replication-task']),
    ],
    'docdb-elastic': [
    ...
    'drs': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):drs:(?P<Region>[\w-]*):(?P<Account>\d{12}):job/(?P<JobID>.+?)$"), ['job-resource']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):drs:(?P<Region>[\w-]*):(?P<Account>\d{12}):launch-configuration-template/(?P<LaunchConfigurationTemplateID>.+?)$"), ['launch-configuration-template-resource']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):drs:(?P<Region>[\w-]*):(?P<Account>\d{12}):recovery-instance/(?P<RecoveryInstanceID>.+?)$"), ['recovery-instance-resource']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):drs:(?P<Region>[\w-]*):(?P<Account>\d{12}):replication-configuration-template/(?P<ReplicationConfigurationTemplateID>.+?)$"), ['replication-configuration-template-resource']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):drs:(?P<Region>[\w-]*):(?P<Account>\d{12}):source-network/(?P<SourceNetworkID>.+?)$"), ['source-network-resource']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):drs:(?P<Region>[\w-]*):(?P<Account>\d{12}):source-server/(?P<SourceServerID>.+?)$"), ['source-server-resource']),
    ],
    'ds': [
    ...
    'emr-containers': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):emr-containers:(?P<Region>[\w-]*):(?P<Account>\d{12}):/virtualclusters/(?P<VirtualClusterId>.+?)/endpoints/(?P<EndpointId>.+?)$"), ['managed-endpoint']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):emr-containers:(?P<Region>[\w-]*):(?P<Account>\d{12}):/virtualclusters/(?P<VirtualClusterId>.+?)/jobruns/(?P<JobRunId>.+?)$"), ['job-run']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):emr-containers:(?P<Region>[\w-]*):(?P<Account>\d{12}):/jobtemplates/(?P<JobTemplateId>.+?)$"), ['job-template']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):emr-containers:(?P<Region>[\w-]*):(?P<Account>\d{12}):/securityconfigurations/(?P<SecurityConfigurationId>.+?)$"), ['security-configuration']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):emr-containers:(?P<Region>[\w-]*):(?P<Account>\d{12}):/virtualclusters/(?P<VirtualClusterId>.+?)$"), ['virtual-cluster']),
    ],
    'emr-serverless': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):emr-serverless:(?P<Region>[\w-]*):(?P<Account>\d{12}):/applications/(?P<ApplicationId>.+?)/jobruns/(?P<JobRunId>.+?)$"), ['job-run']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):emr-serverless:(?P<Region>[\w-]*):(?P<Account>\d{12}):/applications/(?P<ApplicationId>.+?)$"), ['application']),
    ],
    'entityresolution': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):entityresolution:(?P<Region>[\w-]*):(?P<Account>\d{12}):providerservice/(?P<ProviderName>.+?)/(?P<ProviderServiceName>.+?)$"), ['provider-service']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):entityresolution:(?P<Region>[\w-]*):(?P<Account>\d{12}):idmappingworkflow/(?P<WorkflowName>.+?)$"), ['id-mapping-workflow']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):entityresolution:(?P<Region>[\w-]*):(?P<Account>\d{12}):idnamespace/(?P<IdNamespaceName>.+?)$"), ['id-namespace']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):entityresolution:(?P<Region>[\w-]*):(?P<Account>\d{12}):matchingworkflow/(?P<WorkflowName>.+?)$"), ['matching-workflow']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):entityresolution:(?P<Region>[\w-]*):(?P<Account>\d{12}):schemamapping/(?P<SchemaName>.+?)$"), ['schema-mapping']),
    ],
    'es': [
    ...
    'finspace': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):finspace:(?P<Region>[\w-]*):(?P<Account>\d{12}):kxEnvironment/(?P<EnvironmentId>.+?)/kxDatabase/(?P<KxDatabase>.+?)/kxDataview/(?P<KxDataview>.+?)$"), ['kx-dataview']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):finspace:(?P<Region>[\w-]*):(?P<Account>\d{12}):kxEnvironment/(?P<EnvironmentId>.+?)/kxCluster/(?P<KxCluster>.+?)$"), ['kx-cluster']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):finspace:(?P<Region>[\w-]*):(?P<Account>\d{12}):kxEnvironment/(?P<EnvironmentId>.+?)/kxDatabase/(?P<KxDatabase>.+?)$"), ['kx-database']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):finspace:(?P<Region>[\w-]*):(?P<Account>\d{12}):kxEnvironment/(?P<EnvironmentId>.+?)/kxScalingGroup/(?P<KxScalingGroup>.+?)$"), ['kx-scaling-group']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):finspace:(?P<Region>[\w-]*):(?P<Account>\d{12}):kxEnvironment/(?P<EnvironmentId>.+?)/kxUser/(?P<UserName>.+?)$"), ['kx-user']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):finspace:(?P<Region>[\w-]*):(?P<Account>\d{12}):kxEnvironment/(?P<EnvironmentId>.+?)/kxVolume/(?P<KxVolume>.+?)$"), ['kx-volume']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):finspace:(?P<Region>[\w-]*):(?P<Account>\d{12}):environment/(?P<EnvironmentId>.+?)$"), ['environment']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):finspace:(?P<Region>[\w-]*):(?P<Account>\d{12}):kxEnvironment/(?P<EnvironmentId>.+?)$"), ['kx-environment']),
    ...
    'forecast': [
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):forecast:(?P<Region>[\w-]*):(?P<Account>\d{12}):dataset-group/(?P<ResourceId>.+?)$"), ['dataset-group']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):forecast:(?P<Region>[\w-]*):(?P<Account>\d{12}):dataset-import-job/(?P<ResourceId>.+?)$"), ['dataset-import-job']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):forecast:(?P<Region>[\w-]*):(?P<Account>\d{12}):explainability/(?P<ResourceId>.+?)$"), ['explainability']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):forecast:(?P<Region>[\w-]*):(?P<Account>\d{12}):explainability-export/(?P<ResourceId>.+?)$"), ['explainability-export']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):forecast:(?P<Region>[\w-]*):(?P<Account>\d{12}):forecast-export-job/(?P<ResourceId>.+?)$"), ['forecast-export']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):forecast:(?P<Region>[\w-]*):(?P<Account>\d{12}):predictor-backtest-export-job/(?P<ResourceId>.+?)$"), ['predictor-backtest-export-job']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):forecast:(?P<Region>[\w-]*):(?P<Account>\d{12}):what-if-analysis/(?P<ResourceId>.+?)$"), ['what-if-analysis']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):forecast:(?P<Region>[\w-]*):(?P<Account>\d{12}):what-if-forecast/(?P<ResourceId>.+?)$"), ['what-if-forecast']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):forecast:(?P<Region>[\w-]*):(?P<Account>\d{12}):what-if-forecast-export/(?P<ResourceId>.+?)$"), ['what-if-forecast-export']),
    ],
    'frauddetector': [
    ...
    'gamelift': [
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):gamelift:(?P<Region>[\w-]*):(?P<Account>\d{12}):containerfleet/(?P<FleetId>.+?)$"), ['container-fleet']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):gamelift:(?P<Region>[\w-]*):(?P<Account>\d{12}):containergroupdefinition/(?P<Name>.+?)$"), ['container-group-definition']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):gamelift:(?P<Region>[\w-]*):(?P<Account>\d{12}):fleet/(?P<FleetId>.+?)$"), ['fleet']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):gamelift:(?P<Region>[\w-]*):(?P<Account>\d{12}):gameservergroup/(?P<GameServerGroupName>.+?)$"), ['game-server-group']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):gamelift:(?P<Region>[\w-]*):(?P<Account>\d{12}):gamesessionqueue/(?P<GameSessionQueueName>.+?)$"), ['game-session-queue']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):gamelift:(?P<Region>[\w-]*):(?P<Account>\d{12}):location/(?P<LocationId>.+?)$"), ['location']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):gamelift:(?P<Region>[\w-]*):(?P<Account>\d{12}):matchmakingconfiguration/(?P<MatchmakingConfigurationName>.+?)$"), ['matchmaking-configuration']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):gamelift:(?P<Region>[\w-]*):(?P<Account>\d{12}):matchmakingruleset/(?P<MatchmakingRuleSetName>.+?)$"), ['matchmaking-rule-set']),
    ...
    'glue': [
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):glue:(?P<Region>[\w-]*):(?P<Account>\d{12}):customEntityType/(?P<CustomEntityTypeId>.+?)$"), ['custom-entity-type']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):glue:(?P<Region>[\w-]*):(?P<Account>\d{12}):dataQualityRuleset/(?P<RulesetName>.+?)$"), ['data-quality-ruleset']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):glue:(?P<Region>[\w-]*):(?P<Account>\d{12}):mlTransform/(?P<TransformId>.+?)$"), ['ml-transform']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):glue:(?P<Region>[\w-]*):(?P<Account>\d{12}):usageProfile/(?P<UsageProfileId>.+?)$"), ['usage-profile']),
    ...
    'greengrass': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):greengrass:(?P<Region>[\w-]*):(?P<Account>\d{12}):/greengrass/definition/connectors/(?P<ConnectorDefinitionId>.+?)/versions/(?P<VersionId>.+?)$"), ['connector-definition-version']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):greengrass:(?P<Region>[\w-]*):(?P<Account>\d{12}):/greengrass/definition/cores/(?P<CoreDefinitionId>.+?)/versions/(?P<VersionId>.+?)$"), ['core-definition-version']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):greengrass:(?P<Region>[\w-]*):(?P<Account>\d{12}):/greengrass/definition/devices/(?P<DeviceDefinitionId>.+?)/versions/(?P<VersionId>.+?)$"), ['device-definition-version']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):greengrass:(?P<Region>[\w-]*):(?P<Account>\d{12}):/greengrass/definition/functions/(?P<FunctionDefinitionId>.+?)/versions/(?P<VersionId>.+?)$"), ['function-definition-version']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):greengrass:(?P<Region>[\w-]*):(?P<Account>\d{12}):/greengrass/definition/loggers/(?P<LoggerDefinitionId>.+?)/versions/(?P<VersionId>.+?)$"), ['logger-definition-version']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):greengrass:(?P<Region>[\w-]*):(?P<Account>\d{12}):/greengrass/definition/resources/(?P<ResourceDefinitionId>.+?)/versions/(?P<VersionId>.+?)$"), ['resource-definition-version']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):greengrass:(?P<Region>[\w-]*):(?P<Account>\d{12}):/greengrass/definition/subscriptions/(?P<SubscriptionDefinitionId>.+?)/versions/(?P<VersionId>.+?)$"), ['subscription-definition-version']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):greengrass:(?P<Region>[\w-]*):(?P<Account>\d{12}):/greengrass/groups/(?P<GroupId>.+?)/certificateauthorities/(?P<CertificateAuthorityId>.+?)$"), ['certificate-authority']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):greengrass:(?P<Region>[\w-]*):(?P<Account>\d{12}):/greengrass/groups/(?P<GroupId>.+?)/versions/(?P<VersionId>.+?)$"), ['group-version']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):greengrass:(?P<Region>[\w-]*):(?P<Account>\d{12}):components:(?P<ComponentName>.+?):versions:(?P<ComponentVersion>.+?)$"), ['component-version']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):greengrass:(?P<Region>[\w-]*):(?P<Account>\d{12}):/greengrass/bulk/deployments/(?P<BulkDeploymentId>.+?)$"), ['bulk-deployment']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):greengrass:(?P<Region>[\w-]*):(?P<Account>\d{12}):/greengrass/definition/connectors/(?P<ConnectorDefinitionId>.+?)$"), ['connector-definition']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):greengrass:(?P<Region>[\w-]*):(?P<Account>\d{12}):/greengrass/definition/cores/(?P<CoreDefinitionId>.+?)$"), ['core-definition']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):greengrass:(?P<Region>[\w-]*):(?P<Account>\d{12}):/greengrass/definition/devices/(?P<DeviceDefinitionId>.+?)$"), ['device-definition']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):greengrass:(?P<Region>[\w-]*):(?P<Account>\d{12}):/greengrass/definition/functions/(?P<FunctionDefinitionId>.+?)$"), ['function-definition']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):greengrass:(?P<Region>[\w-]*):(?P<Account>\d{12}):/greengrass/definition/loggers/(?P<LoggerDefinitionId>.+?)$"), ['logger-definition']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):greengrass:(?P<Region>[\w-]*):(?P<Account>\d{12}):/greengrass/definition/resources/(?P<ResourceDefinitionId>.+?)$"), ['resource-definition']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):greengrass:(?P<Region>[\w-]*):(?P<Account>\d{12}):/greengrass/definition/subscriptions/(?P<SubscriptionDefinitionId>.+?)$"), ['subscription-definition']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):greengrass:(?P<Region>[\w-]*):(?P<Account>\d{12}):/greengrass/things/(?P<ThingName>.+?)/connectivityInfo$"), ['connectivity-info']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):greengrass:(?P<Region>[\w-]*):(?P<Account>\d{12}):/greengrass/things/(?P<ThingName>.+?)/runtimeconfig$"), ['thing-runtime-config']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):greengrass:(?P<Region>[\w-]*):(?P<Account>\d{12}):coreDevices:(?P<CoreDeviceThingName>.+?)$"), ['core-device']),
    ...
    'groundstation': [
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):groundstation:(?P<Region>[\w-]*):(?P<Account>\d{12}):dataflow-endpoint-group/(?P<DataflowEndpointGroupId>.+?)$"), ['dataflow-endpoint-group']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):groundstation:(?P<Region>[\w-]*):(?P<Account>\d{12}):ephemeris/(?P<EphemerisId>.+?)$"), ['ephemeris-item']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):groundstation:(?P<Region>[\w-]*):(?P<Account>\d{12}):groundstation:(?P<GroundStationId>.+?)$"), ['ground-station-resource']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):groundstation:(?P<Region>[\w-]*):(?P<Account>\d{12}):mission-profile/(?P<MissionProfileId>.+?)$"), ['mission-profile']),
    ...
    'guardduty': [
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):guardduty:(?P<Region>[\w-]*):(?P<Account>\d{12}):detector/(?P<DetectorId>.+?)/publishingdestination/(?P<PublishingDestinationId>.+?)$"), ['publishing-destination']),
    ...
    'identity-sync': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):identity-sync:(?P<Region>[\w-]*):(?P<Account>\d{12}):target/(?P<SyncProfileName>.+?)/(?P<SyncTargetName>.+?)$"), ['sync-target-resource']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):identity-sync:(?P<Region>[\w-]*):(?P<Account>\d{12}):profile/(?P<SyncProfileName>.+?)$"), ['sync-profile-resource']),
    ],
    'identitystore': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):identitystore:::group/(?P<GroupId>.+?)$"), ['group']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):identitystore:::membership/(?P<MembershipId>.+?)$"), ['group-membership']),
    ...
    'imagebuilder': [
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):imagebuilder:(?P<Region>[\w-]*):(?P<Account>\d{12}):container-recipe/(?P<ContainerRecipeName>.+?)/(?P<ContainerRecipeVersion>.+?)$"), ['container-recipe']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):imagebuilder:(?P<Region>[\w-]*):(?P<Account>\d{12}):image/(?P<ImageName>.+?)/(?P<ImageVersion>.+?)$"), ['image-version']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):imagebuilder:(?P<Region>[\w-]*):(?P<Account>\d{12}):image-recipe/(?P<ImageRecipeName>.+?)/(?P<ImageRecipeVersion>.+?)$"), ['image-recipe']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):imagebuilder:(?P<Region>[\w-]*):(?P<Account>\d{12}):distribution-configuration/(?P<DistributionConfigurationName>.+?)$"), ['distribution-configuration']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):imagebuilder:(?P<Region>[\w-]*):(?P<Account>\d{12}):image-pipeline/(?P<ImagePipelineName>.+?)$"), ['image-pipeline']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):imagebuilder:(?P<Region>[\w-]*):(?P<Account>\d{12}):infrastructure-configuration/(?P<ResourceId>.+?)$"), ['infrastructure-configuration']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):imagebuilder:(?P<Region>[\w-]*):(?P<Account>\d{12}):lifecycle-execution/(?P<LifecycleExecutionId>.+?)$"), ['lifecycle-execution']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):imagebuilder:(?P<Region>[\w-]*):(?P<Account>\d{12}):lifecycle-policy/(?P<LifecyclePolicyName>.+?)$"), ['lifecycle-policy']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):imagebuilder:(?P<Region>[\w-]*):(?P<Account>\d{12}):workflow-execution/(?P<WorkflowExecutionId>.+?)$"), ['workflow-execution']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):imagebuilder:(?P<Region>[\w-]*):(?P<Account>\d{12}):workflow-step-execution/(?P<WorkflowStepExecutionId>.+?)$"), ['workflow-step-execution']),
    ],
    'inspector': [
    ...
    'inspector2': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):inspector2:(?P<Region>[\w-]*):(?P<Account>\d{12}):owner/(?P<OwnerId>.+?)/cis-configuration/(?P<CISScanConfigurationId>.+?)$"), ['c-i-s -scan -configuration']),
    ...
    'internetmonitor': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):internetmonitor::(?P<Account>\d{12}):internet-event/(?P<InternetEventId>.+?)$"), ['internet-event']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):internetmonitor:(?P<Region>[\w-]*):(?P<Account>\d{12}):monitor/(?P<MonitorName>.+?)/health-event/(?P<EventId>.+?)$"), ['health-event']),
    ...
    'iotevents': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):iotevents:(?P<Region>[\w-]*):(?P<Account>\d{12}):alarmModel/(?P<AlarmModelName>.+?)$"), ['alarm-model']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):iotevents:(?P<Region>[\w-]*):(?P<Account>\d{12}):detectorModel/(?P<DetectorModelName>.+?)$"), ['detector-model']),
    ...
    'iottwinmaker': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):iottwinmaker:(?P<Region>[\w-]*):(?P<Account>\d{12}):workspace/(?P<WorkspaceId>.+?)/component-type/(?P<ComponentTypeId>.+?)$"), ['component-type']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):iottwinmaker:(?P<Region>[\w-]*):(?P<Account>\d{12}):workspace/(?P<WorkspaceId>.+?)/sync-job/(?P<SyncJobId>.+?)$"), ['sync-job']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):iottwinmaker:(?P<Region>[\w-]*):(?P<Account>\d{12}):metadata-transfer-job/(?P<MetadataTransferJobId>.+?)$"), ['metadata-transfer-job']),
    ...
    'iotwireless': [
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):iotwireless:(?P<Region>[\w-]*):(?P<Account>\d{12}):DeviceProfile/(?P<DeviceProfileId>.+?)$"), ['device-profile']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):iotwireless:(?P<Region>[\w-]*):(?P<Account>\d{12}):FuotaTask/(?P<FuotaTaskId>.+?)$"), ['fuota-task']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):iotwireless:(?P<Region>[\w-]*):(?P<Account>\d{12}):ImportTask/(?P<ImportTaskId>.+?)$"), ['import-task']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):iotwireless:(?P<Region>[\w-]*):(?P<Account>\d{12}):MulticastGroup/(?P<MulticastGroupId>.+?)$"), ['multicast-group']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):iotwireless:(?P<Region>[\w-]*):(?P<Account>\d{12}):NetworkAnalyzerConfiguration/(?P<NetworkAnalyzerConfigurationName>.+?)$"), ['network-analyzer-configuration']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):iotwireless:(?P<Region>[\w-]*):(?P<Account>\d{12}):ServiceProfile/(?P<ServiceProfileId>.+?)$"), ['service-profile']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):iotwireless:(?P<Region>[\w-]*):(?P<Account>\d{12}):SidewalkAccount/(?P<SidewalkAccountId>.+?)$"), ['sidewalk-account']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):iotwireless:(?P<Region>[\w-]*):(?P<Account>\d{12}):WirelessDevice/(?P<WirelessDeviceId>.+?)$"), ['wireless-device']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):iotwireless:(?P<Region>[\w-]*):(?P<Account>\d{12}):WirelessGateway/(?P<WirelessGatewayId>.+?)$"), ['wireless-gateway']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):iotwireless:(?P<Region>[\w-]*):(?P<Account>\d{12}):WirelessGatewayTaskDefinition/(?P<WirelessGatewayTaskDefinitionId>.+?)$"), ['wireless-gateway-task-definition']),
    ],
    'iq': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):iq:(?P<Region>[\w-]*)::paymentRequest/(?P<ConversationId>.+?)/(?P<ProposalId>.+?)/(?P<PaymentRequestId>.+?)$"), ['payment-request']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):iq:(?P<Region>[\w-]*)::paymentSchedule/(?P<ConversationId>.+?)/(?P<ProposalId>.+?)/(?P<VersionId>.+?)$"), ['payment-schedule']),
    ...
    'lambda': [
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):lambda:(?P<Region>[\w-]*):(?P<Account>\d{12}):layer:(?P<LayerName>.+?):(?P<LayerVersion>.+?)$"), ['layer-version']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):lambda:(?P<Region>[\w-]*):(?P<Account>\d{12}):capacity-provider:(?P<CapacityProviderName>.+?)$"), ['capacity-provider']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):lambda:(?P<Region>[\w-]*):(?P<Account>\d{12}):event-source-mapping:(?P<UUID>.+?)$"), ['event-source-mapping']),
    ...
    'lightsail': [
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):lightsail:(?P<Region>[\w-]*):(?P<Account>\d{12}):CloudFormationStackRecord/(?P<Id>.+?)$"), ['cloud-formation-stack-record']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):lightsail:(?P<Region>[\w-]*):(?P<Account>\d{12}):ContactMethod/(?P<Id>.+?)$"), ['contact-method']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):lightsail:(?P<Region>[\w-]*):(?P<Account>\d{12}):ContainerService/(?P<Id>.+?)$"), ['container-service']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):lightsail:(?P<Region>[\w-]*):(?P<Account>\d{12}):Disk/(?P<Id>.+?)$"), ['disk']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):lightsail:(?P<Region>[\w-]*):(?P<Account>\d{12}):DiskSnapshot/(?P<Id>.+?)$"), ['disk-snapshot']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):lightsail:(?P<Region>[\w-]*):(?P<Account>\d{12}):ExportSnapshotRecord/(?P<Id>.+?)$"), ['export-snapshot-record']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):lightsail:(?P<Region>[\w-]*):(?P<Account>\d{12}):Instance/(?P<Id>.+?)$"), ['instance']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):lightsail:(?P<Region>[\w-]*):(?P<Account>\d{12}):InstanceSnapshot/(?P<Id>.+?)$"), ['instance-snapshot']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):lightsail:(?P<Region>[\w-]*):(?P<Account>\d{12}):KeyPair/(?P<Id>.+?)$"), ['key-pair']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):lightsail:(?P<Region>[\w-]*):(?P<Account>\d{12}):LoadBalancer/(?P<Id>.+?)$"), ['load-balancer']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):lightsail:(?P<Region>[\w-]*):(?P<Account>\d{12}):LoadBalancerTlsCertificate/(?P<Id>.+?)$"), ['load-balancer-tls-certificate']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):lightsail:(?P<Region>[\w-]*):(?P<Account>\d{12}):RelationalDatabase/(?P<Id>.+?)$"), ['relational-database']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):lightsail:(?P<Region>[\w-]*):(?P<Account>\d{12}):RelationalDatabaseSnapshot/(?P<Id>.+?)$"), ['relational-database-snapshot']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):lightsail:(?P<Region>[\w-]*):(?P<Account>\d{12}):StaticIp/(?P<Id>.+?)$"), ['static-ip']),
    ],
    'logs': [
    ...
    'lookoutmetrics': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):lookoutmetrics:(?P<Region>[\w-]*):(?P<Account>\d{12}):MetricSet/(?P<AnomalyDetectorName>.+?)/(?P<MetricSetName>.+?)$"), ['metric-set']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):lookoutmetrics:(?P<Region>[\w-]*):(?P<Account>\d{12}):Alert:(?P<AlertName>.+?)$"), ['alert']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):lookoutmetrics:(?P<Region>[\w-]*):(?P<Account>\d{12}):AnomalyDetector:(?P<AnomalyDetectorName>.+?)$"), ['anomaly-detector']),
    ],
    'lookoutvision': [
    ...
    'macie2': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):macie2:(?P<Region>[\w-]*):(?P<Account>\d{12}):allow-list/(?P<ResourceId>.+?)$"), ['allow-list']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):macie2:(?P<Region>[\w-]*):(?P<Account>\d{12}):classification-job/(?P<ResourceId>.+?)$"), ['classification-job']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):macie2:(?P<Region>[\w-]*):(?P<Account>\d{12}):custom-data-identifier/(?P<ResourceId>.+?)$"), ['custom-data-identifier']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):macie2:(?P<Region>[\w-]*):(?P<Account>\d{12}):findings-filter/(?P<ResourceId>.+?)$"), ['findings-filter']),
    ...
    'mediaconnect': [
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mediaconnect:(?P<Region>[\w-]*):(?P<Account>\d{12}):gateway:(?P<GatewayId>.+?):(?P<GatewayName>.+?):instance:(?P<InstanceId>.+?)$"), ['gateway-instance']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mediaconnect:(?P<Region>[\w-]*):(?P<Account>\d{12}):routerInput:(?P<RouterInputId>.+?)$"), ['router-input']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mediaconnect:(?P<Region>[\w-]*):(?P<Account>\d{12}):routerNetworkInterface:(?P<RouterNetworkInterfaceId>.+?)$"), ['router-network-interface']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mediaconnect:(?P<Region>[\w-]*):(?P<Account>\d{12}):routerOutput:(?P<RouterOutputId>.+?)$"), ['router-output']),
    ],
    'mediaconvert': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mediaconvert:(?P<Region>[\w-]*):(?P<Account>\d{12}):certificates/(?P<CertificateArn>.+?)$"), ['certificate-association']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mediaconvert:(?P<Region>[\w-]*):(?P<Account>\d{12}):jobTemplates/(?P<JobTemplateName>.+?)$"), ['job-template']),
    ...
    'mediapackagev2': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mediapackagev2:(?P<Region>[\w-]*):(?P<Account>\d{12}):channelGroup/(?P<ChannelGroupName>.+?)/channel/(?P<ChannelName>.+?)/originEndpoint/(?P<OriginEndpointName>.+?)/harvestJob/(?P<HarvestJobName>.+?)$"), ['harvest-job']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mediapackagev2:(?P<Region>[\w-]*):(?P<Account>\d{12}):channelGroup/(?P<ChannelGroupName>.+?)$"), ['channel-group']),
    ],
    'mediastore': [
    ...
    'mediatailor': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mediatailor:(?P<Region>[\w-]*):(?P<Account>\d{12}):liveSource/(?P<SourceLocationName>.+?)/(?P<LiveSourceName>.+?)$"), ['live-source']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mediatailor:(?P<Region>[\w-]*):(?P<Account>\d{12}):program/(?P<ChannelName>.+?)/(?P<ProgramName>.+?)$"), ['program']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mediatailor:(?P<Region>[\w-]*):(?P<Account>\d{12}):vodSource/(?P<SourceLocationName>.+?)/(?P<VodSourceName>.+?)$"), ['vod-source']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mediatailor:(?P<Region>[\w-]*):(?P<Account>\d{12}):channel/(?P<ChannelName>.+?)$"), ['channel']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mediatailor:(?P<Region>[\w-]*):(?P<Account>\d{12}):playbackConfiguration/(?P<ResourceId>.+?)$"), ['playback-configuration']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mediatailor:(?P<Region>[\w-]*):(?P<Account>\d{12}):prefetchSchedule/(?P<ResourceId>.+?)$"), ['prefetch-schedule']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mediatailor:(?P<Region>[\w-]*):(?P<Account>\d{12}):sourceLocation/(?P<SourceLocationName>.+?)$"), ['source-location']),
    ],
    'medical-imaging': [
    ...
    'mgh': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mgh:(?P<Region>[\w-]*):(?P<Account>\d{12}):progressUpdateStream/(?P<Stream>.+?)/migrationTask/(?P<Task>.+?)$"), ['migration-task']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mgh:(?P<Region>[\w-]*):(?P<Account>\d{12}):automation-run/(?P<RunID>.+?)$"), ['automation-run-resource']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mgh:(?P<Region>[\w-]*):(?P<Account>\d{12}):automation-unit/(?P<AutomationUnitId>.+?)$"), ['automation-unit-resource']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mgh:(?P<Region>[\w-]*):(?P<Account>\d{12}):progressUpdateStream/(?P<Stream>.+?)$"), ['progress-update-stream']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mgh:(?P<Region>[\w-]*):(?P<Account>\d{12}):(?P<ConnectionArn>.+?)$"), ['connection-resource']),
    ],
    'mgn': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mgn:(?P<Region>[\w-]*):(?P<Account>\d{12}):application/(?P<ApplicationID>.+?)$"), ['application-resource']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mgn:(?P<Region>[\w-]*):(?P<Account>\d{12}):connector/(?P<ConnectorID>.+?)$"), ['connector-resource']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mgn:(?P<Region>[\w-]*):(?P<Account>\d{12}):export/(?P<ExportID>.+?)$"), ['export-resource']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mgn:(?P<Region>[\w-]*):(?P<Account>\d{12}):import/(?P<ImportID>.+?)$"), ['import-resource']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mgn:(?P<Region>[\w-]*):(?P<Account>\d{12}):job/(?P<JobID>.+?)$"), ['job-resource']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mgn:(?P<Region>[\w-]*):(?P<Account>\d{12}):launch-configuration-template/(?P<LaunchConfigurationTemplateID>.+?)$"), ['launch-configuration-template-resource']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mgn:(?P<Region>[\w-]*):(?P<Account>\d{12}):network-migration-definition/(?P<NetworkMigrationDefinitionID>.+?)$"), ['network-migration-definition-resource']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mgn:(?P<Region>[\w-]*):(?P<Account>\d{12}):replication-configuration-template/(?P<ReplicationConfigurationTemplateID>.+?)$"), ['replication-configuration-template-resource']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mgn:(?P<Region>[\w-]*):(?P<Account>\d{12}):source-server/(?P<SourceServerID>.+?)$"), ['source-server-resource']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mgn:(?P<Region>[\w-]*):(?P<Account>\d{12}):vcenter-client/(?P<VcenterClientID>.+?)$"), ['vcenter-client-resource']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):mgn:(?P<Region>[\w-]*):(?P<Account>\d{12}):wave/(?P<WaveID>.+?)$"), ['wave-resource']),
    ],
    ...
    'network-firewall': [
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):network-firewall:(?P<Region>[\w-]*):(?P<Account>\d{12}):firewall-policy/(?P<Name>.+?)$"), ['firewall-policy']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):network-firewall:(?P<Region>[\w-]*):(?P<Account>\d{12}):proxy/(?P<Name>.+?)$"), ['proxy']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):network-firewall:(?P<Region>[\w-]*):(?P<Account>\d{12}):proxy-configuration/(?P<Name>.+?)$"), ['proxy-configuration']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):network-firewall:(?P<Region>[\w-]*):(?P<Account>\d{12}):proxy-rule-group/(?P<Name>.+?)$"), ['proxy-rule-group']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):network-firewall:(?P<Region>[\w-]*):(?P<Account>\d{12}):stateful-rulegroup/(?P<Name>.+?)$"), ['stateful-rule-group']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):network-firewall:(?P<Region>[\w-]*):(?P<Account>\d{12}):stateless-rulegroup/(?P<Name>.+?)$"), ['stateless-rule-group']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):network-firewall:(?P<Region>[\w-]*):(?P<Account>\d{12}):tls-configuration/(?P<Name>.+?)$"), ['t-l-s-inspection-configuration']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):network-firewall:(?P<Region>[\w-]*):(?P<Account>\d{12}):vpc-endpoint-association/(?P<Name>.+?)$"), ['vpc-endpoint-association']),
    ],
    'networkflowmonitor': [
    ...
    'notifications': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):notifications::(?P<Account>\d{12}):managed-notification-configuration/category/(?P<Category>.+?)/sub-category/(?P<Subcategory>.+?)/event/(?P<NotificationEventId>.+?)/child-event/(?P<NotificationChildEventId>.+?)$"), ['managed-notification-child-event']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):notifications::(?P<Account>\d{12}):managed-notification-configuration/category/(?P<Category>.+?)/sub-category/(?P<Subcategory>.+?)/event/(?P<NotificationEventId>.+?)$"), ['managed-notification-event']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):notifications::(?P<Account>\d{12}):managed-notification-configuration/category/(?P<Category>.+?)/sub-category/(?P<Subcategory>.+?)$"), ['managed-notification-configuration']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):notifications::(?P<Account>\d{12}):configuration/(?P<NotificationConfigurationId>.+?)/rule/(?P<EventRuleId>.+?)$"), ['event-rule']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):notifications::(?P<Account>\d{12}):configuration/(?P<NotificationConfigurationId>.+?)$"), ['notification-configuration']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):notifications:(?P<Region>[\w-]*):(?P<Account>\d{12}):configuration/(?P<NotificationConfigurationId>.+?)/event/(?P<NotificationEventId>.+?)$"), ['notification-event']),
    ],
    'notifications-contacts': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):notifications-contacts::(?P<Account>\d{12}):emailcontact/(?P<EmailContactId>.+?)$"), ['email-contact-resource']),
    ],
    'nova-act': [
    ...
    'omics': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):omics:(?P<Region>[\w-]*):(?P<Account>\d{12}):annotationStore/(?P<AnnotationStoreName>.+?)/version/(?P<AnnotationStoreVersionName>.+?)$"), ['annotation-store-version']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):omics:(?P<Region>[\w-]*):(?P<Account>\d{12}):sequenceStore/(?P<SequenceStoreId>.+?)/readSet/(?P<ReadSetId>.+?)$"), ['read-set']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):omics:(?P<Region>[\w-]*):(?P<Account>\d{12}):workflow/(?P<Id>.+?)/version/(?P<VersionName>.+?)$"), ['workflow-version']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):omics:(?P<Region>[\w-]*):(?P<Account>\d{12}):annotationStore/(?P<AnnotationStoreName>.+?)$"), ['annotation-store']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):omics:(?P<Region>[\w-]*):(?P<Account>\d{12}):referenceStore/(?P<ReferenceStoreId>.+?)$"), ['reference-store']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):omics:(?P<Region>[\w-]*):(?P<Account>\d{12}):run/(?P<Id>.+?)$"), ['run']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):omics:(?P<Region>[\w-]*):(?P<Account>\d{12}):runCache/(?P<Id>.+?)$"), ['run-cache']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):omics:(?P<Region>[\w-]*):(?P<Account>\d{12}):runGroup/(?P<Id>.+?)$"), ['run-group']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):omics:(?P<Region>[\w-]*):(?P<Account>\d{12}):sequenceStore/(?P<SequenceStoreId>.+?)$"), ['sequence-store']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):omics:(?P<Region>[\w-]*):(?P<Account>\d{12}):task/(?P<Id>.+?)$"), ['task-resource']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):omics:(?P<Region>[\w-]*):(?P<Account>\d{12}):variantStore/(?P<VariantStoreName>.+?)$"), ['variant-store']),
    ...
    'panorama': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):panorama:(?P<Region>[\w-]*):(?P<Account>\d{12}):applicationInstance/(?P<ApplicationInstanceId>.+?)$"), ['application-instance']),
    ...
    'partnercentral': [
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):partnercentral:(?P<Region>[\w-]*)::catalog/(?P<Catalog>.+?)/connection-invitation/(?P<Identifier>.+?)$"), ['connection-invitation']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):partnercentral:(?P<Region>[\w-]*)::catalog/(?P<Catalog>.+?)/opportunity-from-engagement-task/(?P<TaskId>.+?)$"), ['opportunity-from-engagement-task']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):partnercentral:(?P<Region>[\w-]*):(?P<Account>\d{12}):catalog/(?P<Catalog>.+?)/engagement/(?P<EngagementIdentifier>.+?)/resource/(?P<ResourceType>.+?)/(?P<ResourceIdentifier>.+?)/template/(?P<TemplateIdentifier>.+?)/resource-snapshot/(?P<SnapshotRevision>.+?)$"), ['resource-snapshot']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):partnercentral:(?P<Region>[\w-]*):(?P<Account>\d{12}):catalog/(?P<Catalog>.+?)/benefit-allocation/(?P<Identifier>.+?)$"), ['benefit-allocation']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):partnercentral:(?P<Region>[\w-]*):(?P<Account>\d{12}):catalog/(?P<Catalog>.+?)/benefit-application/(?P<Identifier>.+?)$"), ['benefit-application']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):partnercentral:(?P<Region>[\w-]*):(?P<Account>\d{12}):catalog/(?P<Catalog>.+?)/channel-handshake/(?P<Identifier>.+?)$"), ['channel-handshake']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):partnercentral:(?P<Region>[\w-]*):(?P<Account>\d{12}):catalog/(?P<Catalog>.+?)/program-management-account/(?P<Identifier>.+?)$"), ['program-management-account']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):partnercentral:(?P<Region>[\w-]*):(?P<Account>\d{12}):catalog/(?P<Catalog>.+?)/connection-preferences$"), ['connection-preferences']),
    ],
    ...
    'pca-connector-ad': [
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):pca-connector-ad:(?P<Region>[\w-]*):(?P<Account>\d{12}):directory-registration/(?P<DirectoryId>.+?)$"), ['directory-registration']),
    ],
    'pca-connector-scep': [
    ...
    'personalize': [
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):personalize:::feature-transformation/(?P<ResourceId>.+?)$"), ['feature-transformation']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):personalize:::recipe/(?P<ResourceId>.+?)$"), ['recipe']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):personalize:(?P<Region>[\w-]*):(?P<Account>\d{12}):batch-inference-job/(?P<ResourceId>.+?)$"), ['batch-inference-job']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):personalize:(?P<Region>[\w-]*):(?P<Account>\d{12}):batch-segment-job/(?P<ResourceId>.+?)$"), ['batch-segment-job']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):personalize:(?P<Region>[\w-]*):(?P<Account>\d{12}):campaign/(?P<ResourceId>.+?)$"), ['campaign']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):personalize:(?P<Region>[\w-]*):(?P<Account>\d{12}):data-deletion-job/(?P<ResourceId>.+?)$"), ['data-deletion-job']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):personalize:(?P<Region>[\w-]*):(?P<Account>\d{12}):data-insights-job/(?P<ResourceId>.+?)$"), ['data-insights-job']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):personalize:(?P<Region>[\w-]*):(?P<Account>\d{12}):dataset/(?P<ResourceId>.+?)$"), ['dataset']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):personalize:(?P<Region>[\w-]*):(?P<Account>\d{12}):dataset-export-job/(?P<ResourceId>.+?)$"), ['dataset-export-job']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):personalize:(?P<Region>[\w-]*):(?P<Account>\d{12}):dataset-group/(?P<ResourceId>.+?)$"), ['dataset-group']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):personalize:(?P<Region>[\w-]*):(?P<Account>\d{12}):dataset-import-job/(?P<ResourceId>.+?)$"), ['dataset-import-job']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):personalize:(?P<Region>[\w-]*):(?P<Account>\d{12}):event-tracker/(?P<ResourceId>.+?)$"), ['event-tracker']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):personalize:(?P<Region>[\w-]*):(?P<Account>\d{12}):filter/(?P<ResourceId>.+?)$"), ['filter']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):personalize:(?P<Region>[\w-]*):(?P<Account>\d{12}):metric-attribution/(?P<ResourceId>.+?)$"), ['metric-attribution']),
    ...
    'qdeveloper': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):qdeveloper:(?P<Region>[\w-]*):(?P<Account>\d{12}):codeTransformation/(?P<Identifier>.+?)$"), ['code-transformation']),
    ...
    'quicksight': [
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):quicksight:(?P<Region>[\w-]*):(?P<Account>\d{12}):dashboard/(?P<DashboardId>.+?)/snapshot-job/(?P<ResourceId>.+?)$"), ['dashboard-snapshot-job']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):quicksight:(?P<Region>[\w-]*):(?P<Account>\d{12}):asset-bundle-export-job/(?P<ResourceId>.+?)$"), ['asset-bundle-export-job']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):quicksight:(?P<Region>[\w-]*):(?P<Account>\d{12}):asset-bundle-import-job/(?P<ResourceId>.+?)$"), ['asset-bundle-import-job']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):quicksight:(?P<Region>[\w-]*):(?P<Account>\d{12}):email-customization-template/(?P<ResourceId>.+?)$"), ['email-customization-template']),
    ...
    'redshift-serverless': [
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):redshift-serverless:(?P<Region>[\w-]*):(?P<Account>\d{12}):managedvpcendpoint/(?P<EndpointAccessId>.+?)$"), ['endpoint-access']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):redshift-serverless:(?P<Region>[\w-]*):(?P<Account>\d{12}):namespace/(?P<NamespaceId>.+?)$"), ['namespace']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):redshift-serverless:(?P<Region>[\w-]*):(?P<Account>\d{12}):recoverypoint/(?P<RecoveryPointId>.+?)$"), ['recovery-point']),
    ...
    'resource-groups': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):resource-groups:(?P<Region>[\w-]*):(?P<Account>\d{12}):group/(?P<GroupName>.+?)/tag-sync-task/(?P<TaskId>.+?)$"), ['tag-sync-task']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):resource-groups:(?P<Region>[\w-]*):(?P<Account>\d{12}):group/(?P<GroupName>.+?)$"), ['group']),
    ],
    'robomaker': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):robomaker:(?P<Region>[\w-]*):(?P<Account>\d{12}):deployment-fleet/(?P<FleetName>.+?)/(?P<CreatedOnEpoch>.+?)$"), ['deployment-fleet']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):robomaker:(?P<Region>[\w-]*):(?P<Account>\d{12}):robot/(?P<RobotName>.+?)/(?P<CreatedOnEpoch>.+?)$"), ['robot']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):robomaker:(?P<Region>[\w-]*):(?P<Account>\d{12}):robot-application/(?P<ApplicationName>.+?)/(?P<CreatedOnEpoch>.+?)$"), ['robot-application']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):robomaker:(?P<Region>[\w-]*):(?P<Account>\d{12}):simulation-application/(?P<ApplicationName>.+?)/(?P<CreatedOnEpoch>.+?)$"), ['simulation-application']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):robomaker:(?P<Region>[\w-]*):(?P<Account>\d{12}):deployment-job/(?P<DeploymentJobId>.+?)$"), ['deployment-job']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):robomaker:(?P<Region>[\w-]*):(?P<Account>\d{12}):simulation-job/(?P<SimulationJobId>.+?)$"), ['simulation-job']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):robomaker:(?P<Region>[\w-]*):(?P<Account>\d{12}):simulation-job-batch/(?P<SimulationJobBatchId>.+?)$"), ['simulation-job-batch']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):robomaker:(?P<Region>[\w-]*):(?P<Account>\d{12}):world/(?P<WorldId>.+?)$"), ['world']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):robomaker:(?P<Region>[\w-]*):(?P<Account>\d{12}):world-export-job/(?P<WorldExportJobId>.+?)$"), ['world-export-job']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):robomaker:(?P<Region>[\w-]*):(?P<Account>\d{12}):world-generation-job/(?P<WorldGenerationJobId>.+?)$"), ['world-generation-job']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):robomaker:(?P<Region>[\w-]*):(?P<Account>\d{12}):world-template/(?P<WorldTemplateJobId>.+?)$"), ['world-template']),
    ],
    'rolesanywhere': [
    ...
    'rum': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):rum:(?P<Region>[\w-]*):(?P<Account>\d{12}):appmonitor/(?P<Name>.+?)$"), ['app-monitor-resource']),
    ],
    's3': [
    ...
    's3tables': [
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):s3tables:(?P<Region>[\w-]*):(?P<Account>\d{12}):bucket/(?P<TableBucketName>.+?)$"), ['table-bucket']),
    ],
    's3vectors': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):s3vectors:(?P<Region>[\w-]*):(?P<Account>\d{12}):bucket/(?P<BucketName>.+?)/index/(?P<IndexName>.+?)$"), ['index']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):s3vectors:(?P<Region>[\w-]*):(?P<Account>\d{12}):bucket/(?P<BucketName>.+?)$"), ['vector-bucket']),
    ],
    'sagemaker': [
    ...
    'sagemaker-geospatial': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):sagemaker-geospatial:(?P<Region>[\w-]*):(?P<Account>\d{12}):earth-observation-job/(?P<JobID>.+?)$"), ['earth-observation-job']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):sagemaker-geospatial:(?P<Region>[\w-]*):(?P<Account>\d{12}):raster-data-collection/(?P<CollectionID>.+?)$"), ['raster-data-collection']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):sagemaker-geospatial:(?P<Region>[\w-]*):(?P<Account>\d{12}):vector-enrichment-job/(?P<JobID>.+?)$"), ['vector-enrichment-job']),
    ],
    'savingsplans': [
    ...
    'securityagent': [
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):securityagent:(?P<Region>[\w-]*):(?P<Account>\d{12}):agent-space/(?P<AgentId>.+?)/pentest-job/(?P<JobId>.+?)$"), ['pentest-job']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):securityagent:(?P<Region>[\w-]*):(?P<Account>\d{12}):agent-space/(?P<AgentId>.+?)/pentest-task/(?P<TaskId>.+?)$"), ['pentest-task']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):securityagent:(?P<Region>[\w-]*):(?P<Account>\d{12}):agent-instance/(?P<AgentId>.+?)$"), ['agent-instance']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):securityagent:(?P<Region>[\w-]*):(?P<Account>\d{12}):agent-space/(?P<AgentId>.+?)$"), ['agent-space']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):securityagent:(?P<Region>[\w-]*):(?P<Account>\d{12}):security-requirement/(?P<SecurityRequirementId>.+?)$"), ['security-requirement']),
    ],
    'securityhub': [
    ...
    'servicecatalog': [
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):servicecatalog:(?P<Region>[\w-]*):(?P<Account>\d{12}):/attribute-groups/(?P<AttributeGroupId>.+?)$"), ['attribute-group']),
    ],
    'servicediscovery': [
    ...
    'sms-voice': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):sms-voice:(?P<Region>[\w-]*):(?P<Account>\d{12}):sender-id/(?P<SenderId>.+?)/(?P<IsoCountryCode>.+?)$"), ['sender-id']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):sms-voice:(?P<Region>[\w-]*):(?P<Account>\d{12}):configuration-set/(?P<ConfigurationSetName>.+?)$"), ['configuration-set']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):sms-voice:(?P<Region>[\w-]*):(?P<Account>\d{12}):message/(?P<MessageId>.+?)$"), ['message']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):sms-voice:(?P<Region>[\w-]*):(?P<Account>\d{12}):opt-out-list/(?P<OptOutListName>.+?)$"), ['opt-out-list']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):sms-voice:(?P<Region>[\w-]*):(?P<Account>\d{12}):phone-number/(?P<PhoneNumberId>.+?)$"), ['phone-number']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):sms-voice:(?P<Region>[\w-]*):(?P<Account>\d{12}):pool/(?P<PoolId>.+?)$"), ['pool']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):sms-voice:(?P<Region>[\w-]*):(?P<Account>\d{12}):protect-configuration/(?P<ProtectConfigurationId>.+?)$"), ['protect-configuration']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):sms-voice:(?P<Region>[\w-]*):(?P<Account>\d{12}):registration/(?P<RegistrationId>.+?)$"), ['registration']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):sms-voice:(?P<Region>[\w-]*):(?P<Account>\d{12}):registration-attachment/(?P<RegistrationAttachmentId>.+?)$"), ['registration-attachment']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):sms-voice:(?P<Region>[\w-]*):(?P<Account>\d{12}):verified-destination-number/(?P<VerifiedDestinationNumberId>.+?)$"), ['verified-destination-number']),
    ],
    ...
    'sso': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):sso:::permissionSet/(?P<InstanceId>.+?)/(?P<PermissionSetId>.+?)$"), ['permission-set']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):sso::aws:applicationProvider/(?P<ApplicationProviderId>.+?)$"), ['application-provider']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):sso::(?P<AccountId>.+?):application/(?P<InstanceId>.+?)/(?P<ApplicationId>.+?)$"), ['application']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):sso::(?P<AccountId>.+?):trustedTokenIssuer/(?P<InstanceId>.+?)/(?P<TrustedTokenIssuerId>.+?)$"), ['trusted-token-issuer']),
    ],
    'states': [
    ...
    'vendor-insights': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):vendor-insights:::data-source:(?P<ResourceId>.+?)$"), ['data-source']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):vendor-insights:::security-profile:(?P<ResourceId>.+?)$"), ['security-profile']),
    ],
    'verifiedpermissions': [
    ...
    'vpc-lattice': [
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):vpc-lattice:(?P<Region>[\w-]*):(?P<Account>\d{12}):accesslogsubscription/(?P<AccessLogSubscriptionId>.+?)$"), ['access-log-subscription']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):vpc-lattice:(?P<Region>[\w-]*):(?P<Account>\d{12}):domainverification/(?P<DomainVerificationId>.+?)$"), ['domain-verification']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):vpc-lattice:(?P<Region>[\w-]*):(?P<Account>\d{12}):resourceconfiguration/(?P<ResourceConfigurationId>.+?)$"), ['resource-configuration']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):vpc-lattice:(?P<Region>[\w-]*):(?P<Account>\d{12}):resourceendpointassociation/(?P<ResourceEndpointAssociationId>.+?)$"), ['resource-endpoint-association']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):vpc-lattice:(?P<Region>[\w-]*):(?P<Account>\d{12}):resourcegateway/(?P<ResourceGatewayId>.+?)$"), ['resource-gateway']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):vpc-lattice:(?P<Region>[\w-]*):(?P<Account>\d{12}):service/(?P<ServiceId>.+?)$"), ['service']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):vpc-lattice:(?P<Region>[\w-]*):(?P<Account>\d{12}):servicenetwork/(?P<ServiceNetworkId>.+?)$"), ['service-network']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):vpc-lattice:(?P<Region>[\w-]*):(?P<Account>\d{12}):servicenetworkresourceassociation/(?P<ServiceNetworkResourceAssociationId>.+?)$"), ['service-network-resource-association']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):vpc-lattice:(?P<Region>[\w-]*):(?P<Account>\d{12}):servicenetworkserviceassociation/(?P<ServiceNetworkServiceAssociationId>.+?)$"), ['service-network-service-association']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):vpc-lattice:(?P<Region>[\w-]*):(?P<Account>\d{12}):servicenetworkvpcassociation/(?P<ServiceNetworkVpcAssociationId>.+?)$"), ['service-network-vpc-association']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):vpc-lattice:(?P<Region>[\w-]*):(?P<Account>\d{12}):targetgroup/(?P<TargetGroupId>.+?)$"), ['target-group']),
    ],
    'waf': [
    ...
    'wisdom': [
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):wisdom:(?P<Region>[\w-]*):(?P<Account>\d{12}):content-association/(?P<KnowledgeBaseId>.+?)/(?P<ContentId>.+?)/(?P<ContentAssociationId>.+?)$"), ['content-association']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):wisdom:(?P<Region>[\w-]*):(?P<Account>\d{12}):ai-agent/(?P<AssistantId>.+?)/(?P<AIAgentId>.+?)$"), ['a-i-agent']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):wisdom:(?P<Region>[\w-]*):(?P<Account>\d{12}):ai-guardrail/(?P<AssistantId>.+?)/(?P<AIGuardrailId>.+?)$"), ['a-i-guardrail']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):wisdom:(?P<Region>[\w-]*):(?P<Account>\d{12}):ai-prompt/(?P<AssistantId>.+?)/(?P<AIPromptId>.+?)$"), ['a-i-prompt']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):wisdom:(?P<Region>[\w-]*):(?P<Account>\d{12}):association/(?P<AssistantId>.+?)/(?P<AssistantAssociationId>.+?)$"), ['assistant-association']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):wisdom:(?P<Region>[\w-]*):(?P<Account>\d{12}):content/(?P<KnowledgeBaseId>.+?)/(?P<ContentId>.+?)$"), ['content']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):wisdom:(?P<Region>[\w-]*):(?P<Account>\d{12}):message-template/(?P<KnowledgeBaseId>.+?)/(?P<MessageTemplateId>.+?)$"), ['message-template']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):wisdom:(?P<Region>[\w-]*):(?P<Account>\d{12}):quick-response/(?P<KnowledgeBaseId>.+?)/(?P<QuickResponseId>.+?)$"), ['quick-response']),
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):wisdom:(?P<Region>[\w-]*):(?P<Account>\d{12}):knowledge-base/(?P<KnowledgeBaseId>.+?)$"), ['knowledge-base']),
    ],
    'workdocs': [
    ...
    'workmailmessageflow': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):workmailmessageflow:(?P<Region>[\w-]*):(?P<Account>\d{12}):message/(?P<OrganizationId>.+?)/(?P<Context>.+?)/(?P<MessageId>.+?)$"), ['raw-message']),
    ],
    'workspaces': [
    ...
    'workspaces-instances': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):workspaces-instances:(?P<Region>[\w-]*):(?P<Account>\d{12}):workspaceinstance/(?P<WorkspaceInstanceId>.+?)$"), ['workspace-instance-id']),
    ],
    'workspaces-web': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):workspaces-web:(?P<Region>[\w-]*):(?P<Account>\d{12}):identityProvider/(?P<PortalId>.+?)/(?P<IdentityProviderId>.+?)$"), ['identity-provider']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):workspaces-web:(?P<Region>[\w-]*):(?P<Account>\d{12}):browserSettings/(?P<BrowserSettingsId>.+?)$"), ['browser-settings']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):workspaces-web:(?P<Region>[\w-]*):(?P<Account>\d{12}):dataProtectionSettings/(?P<DataProtectionSettingsId>.+?)$"), ['data-protection-settings']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):workspaces-web:(?P<Region>[\w-]*):(?P<Account>\d{12}):ipAccessSettings/(?P<IpAccessSettingsId>.+?)$"), ['ip-access-settings']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):workspaces-web:(?P<Region>[\w-]*):(?P<Account>\d{12}):networkSettings/(?P<NetworkSettingsId>.+?)$"), ['network-settings']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):workspaces-web:(?P<Region>[\w-]*):(?P<Account>\d{12}):portal/(?P<PortalId>.+?)$"), ['portal']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):workspaces-web:(?P<Region>[\w-]*):(?P<Account>\d{12}):sessionLogger/(?P<SessionLoggerId>.+?)$"), ['session-logger']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):workspaces-web:(?P<Region>[\w-]*):(?P<Account>\d{12}):trustStore/(?P<TrustStoreId>.+?)$"), ['trust-store']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):workspaces-web:(?P<Region>[\w-]*):(?P<Account>\d{12}):userAccessLoggingSettings/(?P<UserAccessLoggingSettingsId>.+?)$"), ['user-access-logging-settings']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):workspaces-web:(?P<Region>[\w-]*):(?P<Account>\d{12}):userSettings/(?P<UserSettingsId>.+?)$"), ['user-settings']),
    ],
    'xray': [
