...
ARN_PATTERNS = {
    ...
    'identitystore': [
        ...
        (re.compile(r"^arn:(?P<Partition>[\w-]+):identitystore::(?P<Account>\d{12}):identitystore/(?P<IdentityStoreId>.+?)$"), ['identitystore', 'Identitystore']),
    ],
    'imagebuilder': [
    ...
    'iotdeviceadvisor': [
        (re.compile(r"^arn:(?P<Partition>[\w-]+):iotdeviceadvisor:(?P<Region>[\w-]*):(?P<Account>\d{12}):suiterun/(?P<SuiteDefinitionId>.+?)/(?P<SuiteRunId>.+?)$"), ['suiterun', 'Suiterun']),
        (re.compile(r"^arn:(?P<Partition>[\w-]+):iotdeviceadvisor:(?P<Region>[\w-]*):(?P<Account>\d{12}):suitedefinition/(?P<SuiteDefinitionId>.+?)$"), ['suitedefinition', 'Suitedefinition']),
    ],
    'iotevents': [
...
AWS_CLOUDFORMATION_RESOURCES = {
    ...
    'appsync': {'api': 'AWS::AppSync::Api', 'channel-namespace': 'AWS::AppSync::ChannelNamespace', 'datasource': 'AWS::AppSync::DataSource', 'domain': 'AWS::AppSync::DomainName', 'function': 'AWS::AppSync::FunctionConfiguration', 'graphqlapi': 'AWS::AppSync::GraphQLApi', 'merged-api-association': 'AWS::AppSync::SourceApiAssociation', 'source-api-association': 'AWS::AppSync::SourceApiAssociation'},
    ...
    'guardduty': {'detector': 'AWS::GuardDuty::Detector', 'filter': 'AWS::GuardDuty::Filter', 'ipset': 'AWS::GuardDuty::IPSet', 'malwareprotectionplan': 'AWS::GuardDuty::MalwareProtectionPlan', 'publishing-destination': 'AWS::GuardDuty::PublishingDestination', 'threatentityset': 'AWS::GuardDuty::ThreatEntitySet', 'threatintelset': 'AWS::GuardDuty::ThreatIntelSet', 'trustedentityset': 'AWS::GuardDuty::TrustedEntitySet'},
